      ...
      <div style={{ maxWidth: 880, margin: "0 auto", padding: "64px 24px" }}>
        ...
        <Section title="الباقات والمدفوعات">
          <ul style={ulStyle}>
            ...
            <li>الدفع لمرة واحدة يمنحك صلاحيات الباقة المختارة وفقًا للوصف المعلن.</li>
            <li>المبالغ المدفوعة غير قابلة للاسترداد بعد تحميل السيرة الذاتية بصيغة PDF أو DOCX.</li>
          </ul>
        </Section>
        ...
        <Section title="التواصل والدعم">
          لأي استفسار، تواصل معنا عبر واتساب: <a href="https://wa.me/966552967837" target="_blank" rel="noreferrer" style={{ color: P.violetLight }}>+966 55 296 7837</a>
        </Section>
      </div>
    </div>
  );
