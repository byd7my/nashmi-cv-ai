...
export const TR = {
  en: {
    ...
    features: [
      ...
      { icon: "✧", title: "AI Copilot Sidebar",   desc: "Chat with your AI copilot. Ask it to optimize, rewrite, or tailor your resume for any job posting." },
    ],
    ...
    plans: [
      ...
      },
      {
        ...
        features: [
          ...
          { text: "AI Copilot chat",              included: true  },
    ...
    aiImprove: "AI Improve", aiCopilot: "AI Copilot",
    addItem: "+ Add", removeItem: "Remove",
    copilotTitle: "AI Copilot",
    copilotPlaceholder: "Ask AI to improve your resume…",
    copilotSend: "Send",
  ...
  ar: {
    ...
    features: [
      ...
      { icon: "✧", title: "مساعد AI الجانبي",    desc: "تحدث مع مساعدك الذكي. اطلب منه تحسين سيرتك أو إعادة صياغتها أو تكييفها لأي وظيفة." },
    ],
    ...
    plans: [
      ...
      },
      {
        ...
        features: [
          ...
          { text: "دردشة AI Copilot",               included: true  },
    ...
    aiImprove: "تحسين AI", aiCopilot: "مساعد AI",
    addItem: "+ إضافة", removeItem: "حذف",
    copilotTitle: "مساعد AI",
    copilotPlaceholder: "اطلب من AI تحسين سيرتك…",
    copilotSend: "إرسال",
