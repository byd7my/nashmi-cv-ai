...
export const TR = {
  en: {
    ...
    features: [
      ...
      { icon: "✧", title: "AI Writing & Assistant", desc: "Craft professional bullets and summaries, improve and rewrite your resume, tailor it to any role — chat directly with your AI assistant." },
  ...
  ar: {
    ...
    features: [
      ...
      { icon: "✧", title: "مساعد الذكاء الاصطناعي", desc: "صياغة نقاط وملخصات احترافية، تحسين السيرة وإعادة صياغتها، وتكييفها لأي وظيفة — مع محادثة مباشرة مع المساعد." },
