...
export const TR = {
  en: {
    ...
    ctaSub: "No credit card required  ·  ATS-friendly PDF export",
    ...
    features: [
      ...
      { icon: "⬡", title: "Smart Import",          desc: "Upload a resume (PDF, TXT, JSON, or photo) and our AI extracts and maps all your data instantly." },
    ...
    plans: [
      ...
      },
      {
        ...
        highlight: false, popular: false, ctaNav: "whatsapp",
    ...
    builderNav: ["Personal", "Summary", "Experience", "Education", "Certifications", "Projects", "Skills", "Languages"],
  ...
  ar: {
    ...
    ctaSub: "لا يلزم بطاقة ائتمانية  ·  تصدير PDF متوافق ATS",
    ...
    features: [
      ...
      { icon: "⬡", title: "استيراد ذكي",          desc: "ارفع سيرتك (PDF، TXT، JSON، أو صورة) وسيستخرج الذكاء الاصطناعي جميع بياناتك فوراً." },
    ...
    builderNav: ["الشخصية","الملخص","الخبرة","التعليم","الشهادات","المشاريع","المهارات","اللغات"],
